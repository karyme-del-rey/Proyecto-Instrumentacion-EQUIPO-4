...
\begin{minipage}[c]{0.25\linewidth}
  \centering
  \includegraphics[width=2.8cm]{figuras/logo_ipn.png}
\end{minipage}
\hfill
\begin{minipage}[c]{0.46\linewidth}
  \centering
  {\normalsize\bfseries\color{ipnguinda} Instituto Politécnico Nacional}\\[2pt]
  {\small\bfseries Escuela Superior de Ingeniería}\\
  {\small\bfseries Química e Industrias Extractivas}\\[1pt]
  {\footnotesize Academia de Diseño e Ingeniería de Apoyo}
\end{minipage}
\hfill
\begin{minipage}[c]{0.22\linewidth}
  \centering
  \includegraphics[width=2.4cm]{figuras/logo_esiqie.png}
\end{minipage}

\vspace{3pt}
{\color{ipnguinda}\rule{\linewidth}{1.2pt}}

\vspace{0.5cm}

\begin{center}

{\normalsize\bfseries\color{grisnota} MATERIA:}\\[2pt]
{\large\bfseries\color{azulacero} INSTRUMENTACIÓN INDUSTRIAL}\\[0.4cm]

{\color{ipnguinda}\rule{0.55\linewidth}{0.6pt}}\\[0.3cm]

{\fontsize{19}{24}\selectfont\bfseries\color{ipnguinda}
  SISTEMA DE CONTROL E INSTRUMENTACIÓN\\[4pt]
  PARA UNA COLUMNA DE ABSORCIÓN
}\\[0.3cm]

{\color{ipnguinda}\rule{0.55\linewidth}{0.6pt}}\\[0.5cm]
...
\begin{tcolorbox}[
  ...
  arc=5pt,
  boxrule=1pt,
  title={\small\bfseries\color{white} INTEGRANTES},
  attach boxed title to top center={yshift=-2mm},
  boxed title style={colback=ipnguinda, size=small},
  top=4pt, bottom=4pt
]
\centering
...
{\normalsize\bfseries PROFESOR:}\\[2pt]
{\large Ing. José Ignacio Rauda Rodríguez}\\[0.4cm]

\begin{tabular}{cc}
  \large\bfseries GRUPO: & \large\bfseries EQUIPO: \\[1pt]
  \normalsize 5IV81 & \normalsize No. 4 \\
\end{tabular}

\vspace{0.4cm}
{\normalsize\color{grisnota} Ciudad de México, 27 de mayo de 2026}
